...
KP_liberation_little_bird_classname = "BRAF_Fennec_Unarmed_MB";              // These are the little birds which spawn on the Freedom or at Chimera base.
...
infantry_units = [
	    ["braf_army_rifleman_regular_2000", 20, 0, 0], // Rifleman (Light)
...
heavy_vehicles = [
	    ["BRAF_GUARANI_BASE", 200, 40, 100], // M113A3 (M2)
	    ["BRAF_EE9_Cascavel_EB", 200, 100, 100], // M113A3 (M2)
	    ["BRAF_LMV_EB_RCWS", 150, 50, 50], // M113A3 (Mk19)
	    ["BRAF_LMV_EB", 150, 50, 50] // M113A3 (Medical)
